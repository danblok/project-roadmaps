/*
  ...
  - You are about to drop the `_ProjectToAccount` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "_ProjectToAccount" DROP CONSTRAINT "_ProjectToAccount_A_fkey";

-- DropForeignKey
ALTER TABLE "_ProjectToAccount" DROP CONSTRAINT "_ProjectToAccount_B_fkey";
...
-- AddForeignKey
ALTER TABLE "_contributed_projects" ADD CONSTRAINT "_contributed_projects_B_fkey" FOREIGN KEY ("B") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;
